...
async function applyHackingTransition() {
  ...
  // Get IP using hybrid browser-based approach (no external API)
...
document.addEventListener("DOMContentLoaded", function() {
  ...
  if (hamMenuIcon && navBar) {
    ...
    hamMenuIcon.addEventListener("click", () => {
      ...
      if (Post) Post.style.display = Post.style.display === "none" ? "block" : "none";
      if (CMI) CMI.style.display = CMI.style.display === "none" ? "block" : "none";
